...
import com.idi.vaccinetracker.common.data.database.daos.base.DraftParticipantDaoBase
import com.idi.vaccinetracker.common.data.database.daos.base.DraftParticipantSyncDao
...
interface DraftParticipantDao : DraftParticipantDaoBase<DraftParticipantEntity, RoomDraftParticipantModel>, ObservableDao, DraftParticipantSyncDao {
    ...
    @Query("select * from draft_participant left join draft_participant_address using (participantUuid) where nin=:participantNin")
    @Transaction
    override suspend fun findByParticipantNin(participantNin: String): RoomDraftParticipantModel?
