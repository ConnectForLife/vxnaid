...
import com.idi.vaccinetracker.databinding.ActivityVisitBinding
    ...
    override fun onReferralAfterContraindicationsPageFinish(finish:Boolean) {
        ...
        lifecycleScope.launch {
            try {
                ...
                com.idi.vaccinetracker.common.dialogs.AlertDialog(context).showAlertDialog(getString(R.string.reschedule_visit_failed))
            }
        }
    }
