package com.idi.vaccinetracker.sync.data.network

import com.idi.vaccinetracker.common.data.helpers.WebCallUtil
import com.idi.vaccinetracker.common.data.models.ParticipantMatchDto
import com.idi.vaccinetracker.common.data.models.api.request.*
import com.idi.vaccinetracker.common.data.models.api.response.*
import com.idi.vaccinetracker.common.data.network.VaccineTrackerApiDataSourceBase
...
interface VaccineTrackerSyncApiDataSource : VaccineTrackerApiDataSourceBase {
    ...
    suspend fun reportAdverseEffectForPatient(patientUuid: String, adverseEffectsText: String)
}
...
class VaccineTrackerSyncApiDataSourceDefault @Inject constructor(
    ...
    override suspend fun reportAdverseEffectForPatient(patientUuid: String, adverseEffectsText: String) {
        apiService.reportAdverseEffectForPatient(patientUuid, adverseEffectsText)
    }
}