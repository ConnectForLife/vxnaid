package com.idi.vaccinetracker.sync.p2p.domain.services
...
import com.idi.vaccinetracker.common.domain.entities.ImageFileWithContent
import com.idi.vaccinetracker.common.domain.entities.TemplateFileWithContent
import com.idi.vaccinetracker.common.domain.entities.readContent
import com.idi.vaccinetracker.common.helpers.*
import com.idi.vaccinetracker.sync.data.repositories.SyncSettingsRepository
import com.idi.vaccinetracker.sync.p2p.common.Messenger
import com.idi.vaccinetracker.sync.p2p.common.models.*
import com.idi.vaccinetracker.sync.p2p.common.models.CompatibleNsdDevice.Companion.toNsdDevice
import com.idi.vaccinetracker.sync.p2p.common.models.dtos.messages.ClientMessage
import com.idi.vaccinetracker.sync.p2p.common.models.dtos.messages.ServerMessage
import com.idi.vaccinetracker.sync.p2p.common.models.dtos.messages.ServerMessage.*
import com.idi.vaccinetracker.sync.p2p.common.models.dtos.messages.ServerMessage.LoginReply.Companion.toLoginReplyStatus
import com.idi.vaccinetracker.sync.p2p.common.models.dtos.messages.ServerMessageHeaders
...
import com.idi.vaccinetracker.sync.p2p.data.ClientMessageReceiver
import com.idi.vaccinetracker.sync.p2p.data.factories.reply.SecretsReplyFactory
import com.idi.vaccinetracker.sync.p2p.data.helpers.ServerProgressProvider
import com.idi.vaccinetracker.sync.p2p.data.helpers.calcProgress
import com.idi.vaccinetracker.sync.p2p.domain.entities.ServerProgress
import com.idi.vaccinetracker.sync.p2p.domain.exceptions.SendMessageException
import com.idi.vaccinetracker.sync.p2p.domain.usecases.IsDatabaseValidUseCase
import com.idi.vaccinetracker.sync.p2p.domain.usecases.PrepareDatabaseForExportUseCase
