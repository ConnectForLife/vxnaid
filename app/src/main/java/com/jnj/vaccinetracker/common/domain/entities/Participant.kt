...
sealed class ParticipantBase {
    ...
    val dataEntrantName: String? get() = attributes[Constants.ATTRIBUTE_DATA_ENTRANT_NAME]
    val dataEntrantLastName: String? get() = attributes[Constants.ATTRIBUTE_DATA_ENTRANT_LAST_NAME]
